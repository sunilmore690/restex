...
let models = []
class Dao {
  constructor(app,{database:{conn:{mongooseConnection,uri}},controllersPath,modelsPath,routesPath,middlewaresPath}) {
    ...
    models = require("./models_init")(this.mongoose ,modelsPath);
